                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="hidden-sm hidden-xs action-buttons">
                                                            <a class="blue" href="{{asset('dashboard/detail_car/'. $car->id)}}">
                                                                <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                            </a>
                                                            @can('update-car')

                                                            <a class="green" href="{{asset('dashboard/edit_car/'. $car->id)}}">
                                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                            </a>
                                                            @endcan
                                                          @can('delete-car')
                                                            <a class="red" href="javascript:void()"
                                                               onclick="delete_record(<?php echo $car->id;?>);">
                                                                <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                                <script>
                                                                    function delete_record(id) {
                                                                        var del = window.confirm("Are you sure to delete this record?");
                                                                        if (del == true) {
                                                                            window.location.assign("{{asset('dashboard/delete_car')}}/" + id);
                                                                        }
                                                                    }
                                                                </script>
                                                            </a>

                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="hidden-sm hidden-xs action-buttons">
                                                            <a class="blue" href="detail_new/<?php echo $new->id;?>">
                                                                <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                            </a>

                                                            <a class="green" href="edit_new/<?php echo $new->id;?>">
                                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                            </a>

                                                            <a class="red" href="javascript:void()"
                                                               onclick="delete_record(<?php echo $new->id;?>);">
                                                                <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                                <script>
                                                                    function delete_record(id) {
                                                                        var del = window.confirm("Are you sure to delete this record?");
                                                                        if (del == true) {
                                                                            window.location.assign("delete_new/" + id);
                                                                        }
                                                                    }
                                                                </script>
                                                            </a>

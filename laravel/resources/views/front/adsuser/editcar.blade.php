                    ...
                    <div class="col-md-12">
                        <div id="main">
                            ...
                            <div class="content white block block-margin adsactions" style="">
                                <h2 class="detailbrand">{{trans('greeting.edit_car')}}</h2>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-lg-12" style="margin-top:15px;">
                                            {!! Form::model($edit_car,['method'=>'PATCH','url'=>'/'.$lang_path.'/user/'.Auth::user()->id.'/editcar/'.$edit_car->id,'class'=>'form-group','enctype'=>"multipart/form-data"]) !!}
                                            <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group col-sm-12 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control form-custom" id="field-tags" value="{{$edit_car->appliances}}" data-role="tagsinput" />
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group col-sm-12 col-md-6">
                                                    ...
                                                    {!! Form::file('photo2',['class'=>'form-control form-custom','id'=>'id-input-file-2']) !!}
                                                ...
                                                <div class="form-group col-sm-12 col-md-6">
                                                    ...
                                                    {!! Form::file('photo3',['class'=>'form-control form-custom','id'=>'id-input-file-2']) !!}
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group col-sm-12 col-md-6">
                                                    ...
                                                    {!! Form::file('photo4',['class'=>'form-control form-custom','id'=>'id-input-file-2']) !!}
                                                ...
                                                <div class="form-group col-sm-12 col-md-6">
                                                    ...
                                                    {!! Form::file('photo5',['class'=>'form-control form-custom','id'=>'id-input-file-2']) !!}
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group col-sm-12 col-md-6">
                                                    ...
                                                    {!! Form::file('photo1',['class'=>'form-control form-custom','id'=>'id-input-file-2']) !!}

            ...
            <div class="main-content-inner">
                <div class="breadcrumbs" id="breadcrumbs">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="#">Details of Contact's Mail</a>
                        </li>
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8 ">{{$detail->email}}</div>
                        ...
                        <div class="col-xs-2 ">:</div>
                        <div class="col-xs-8 ">{{$detail->subject}}</div>
                        <div style="clear:both;">&nbsp;</div>
                        <div class="col-xs-2">Message</div>
                        <div class="col-xs-2 ">:</div>
                        <div class="col-xs-8 ">{{$detail->message}}</div>
                        <div style="clear:both;">&nbsp;</div>
                        <div class="col-xs-2">Date</div>
                        <div class="col-xs-2 ">:</div>
                        <div class="col-xs-8 ">{{$detail->send_at}}
                        </div>
                        <div style="clear:both;">&nbsp;</div>
                    ...
                    <script>
                        function delete_record(id) {
                            ...
                            if (del == true) {
                                window.location.assign("../../dashboard/contact-delete/" + id);
                            }
                        }
                    </script>
